		...
		<div className=" mx-5 grid grid-cols-[w-full] grid-rows-[auto_3.25rem_auto_2.4375rem_auto_3.25rem_2.4375rem_auto] gap-y-3">
			<div className="container Profile text-white flex flex-row justify-items-center items-center gap-x-2.5">
				<img
					src={Profile_Picture}
					alt="My Picture"
					className="w-[3.8125rem] xxs:w-[5.8125rem] xs:w-[6.8125rem]"
				></img>
				<div className="grid grid-rows-[auto auto] justify-items-start">
					<h1 className="text-4xl xxs:text-[2.5rem] xs:text-5xl font-extrabold uppercase translate-y-[.25rem]">
						menma
					</h1>
					<h2 className="text-[0.6rem] xxs:text-[0.650rem] xs:text-[0.8rem] font-extrabold uppercase  translate-y-[-.25rem]">
						Christian Emmanuel Collo
					</h2>
				</div>
			</div>
